...
//      - When you initialise an object with another object of the same class
//          ```
//            A a_2;
//            A a_1 = a_2
//          ```
//      - When you pass an object by value to a function
//          ```
//            ...
//            
//            void func(A a)
...
//              return a;
//            }
//      - When you explicitly call the copy constructor
//  - What are special member functions, and does C++ generate the move constructor?
//      If there is no move constructor, the copy constructor is called.

// Good explanation here: https://learn.microsoft.com/en-us/cpp/cpp/explicitly-defaulted-and-deleted-functions?view=msvc-170

// Special member functions are automatically generated by the compiler if used,
// without being declared explicitly by the programmer. 


// Default constructor (if no other constructor is explicitly declared).
// Copy constructor (if no move constructor/ move assignment is explicitly declared, in which case copying is disabled. If destructor is declared, then this is deprecated).
// Move constructor (if no copy constructor, copy assignment, move assignment and destructor are explicitly declared).
// Copy assignment (if no move constructor/ move assignment are explicitly declared. If destructor is declared, this is deprecated).
// Move assignment (if no copy constructor/ copy assignment/ move constructor/ destructor are explicitly declared).
// Destructor
